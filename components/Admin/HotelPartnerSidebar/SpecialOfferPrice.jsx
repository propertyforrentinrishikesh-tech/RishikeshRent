...
const SpecialOfferPrice = ({ propertyData }) => {
    // Form States
        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.data.length > 0) {
                    ...
                    setOfferName(pricing.offerName)
                    setOfferDescription(pricing.offerDescription)
                }
            }
        } catch (error) {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            if (data.success) {
                toast.success(`Special offer pricing updated successfully for ${data.data?.datesUpdated || 'all'} dates!`)
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-6">
            ...
            {/* Special Offer Details - Only show if dates and room are selected */}
            {startDate && endDate && selectedRoom && (
                <Card className="border-2 border-orange-200 bg-orange-50">
                    <CardContent className="p-6">
                        <div className="space-y-4">
                            <div>
                                <h3 className="font-bold text-lg text-orange-900 mb-2">Special Offer Details</h3>
                                <p className="text-sm text-orange-700">
                                    Create promotional pricing for holidays, festivals, or special events
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g., Diwali Special, New Year Offer"
                    ...
                    <Card className="border-2 border-orange-200 bg-orange-50">
                        <CardContent className="p-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-lg text-orange-900">Special Offer Pricing</h3>
                                    ...
                                    <p className="text-orange-700 text-xs mt-2">
                                        This will apply promotional pricing to all dates in the selected range.
                                    </p>
                                </div>
                            </div>
                        </CardContent>
                ...
                <Card className="border-2 border-orange-200 bg-orange-50">
                    <CardContent className="p-6 text-center">
                        <p className="text-orange-900 font-semibold">
                            👆 Please select start date, end date, and room category to set special offer pricing
                        </p>
                    </CardContent>
                </Card>
            ) : null}
            ...
            {showModal && selectedCategoryData && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full min-h-[50vh] overflow-y-auto max-h-[80vh]">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                                <h3 className="font-bold text-gray-900 mb-2">Special Offer Information</h3>
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        <span className="text-gray-600">Offer Name:</span>
                                        <span className={`ml-2 font-semibold ${selectedCategoryData.offerName === 'open' ? 'text-green-600' : 'text-red-600'
                                            }`}>
                                            {selectedCategoryData.offerName.toUpperCase()}
                                        </span>
                                    </div>
                                    <div>
                                        <span className="text-gray-600">Offer Description:</span>
                                        <span className="ml-2 font-semibold text-gray-900 text-wrap">
                                            {selectedCategoryData.offerDescription || "No Description"}
                                        </span>
                                    </div>
                                </div>
                            </div>
