    ...
    return (
        <div className="w-full mx-auto p-6 space-y-6 bg-white">
            ...
            <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-4 rounded-lg shadow-sm">
                <h1 className="text-2xl font-bold text-gray-800">Date Range Bulk Price Update</h1>
            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white"
                                >
                ...
                <div className="space-y-4">
                    ...
                    <Card className="bg-orange-600 shadow-lg">
                        <CardContent className="p-4">
                            ...
                            >
                                ...
                                <ChevronDown
                                    className={`h-5 w-5 text-white transition-transform ${expandedSections.ep ? 'rotate-180' : ''
                                        }`}
                                />
                            </button>
                            {expandedSections.ep && (
                    ...
                    <Card className="bg-orange-600 shadow-lg">
                        <CardContent className="p-4">
                            ...
                            >
                                ...
                                <ChevronDown
                                    className={`h-5 w-5 text-white transition-transform ${expandedSections.cp ? 'rotate-180' : ''
                                        }`}
                                />
                            </button>
                            {expandedSections.cp && (
                    ...
                    <Card className="bg-orange-600 shadow-lg">
                        <CardContent className="p-4">
                            ...
                            >
                                ...
                                <ChevronDown
                                    className={`h-5 w-5 text-white transition-transform ${expandedSections.map ? 'rotate-180' : ''
                                        }`}
                                />
                            </button>
                    ...
                    <Card className="bg-orange-600 shadow-lg">
                        <CardContent className="p-4">
                            <button
                                type="button"
                                onClick={() => toggleSection('ap')}
                                className="w-full flex items-center justify-between mb-3"
                            >
                                <h3 className="text-white font-bold text-lg">On AP Basis</h3>
                                <ChevronDown
                                    className={`h-5 w-5 text-white transition-transform ${expandedSections.ap ? 'rotate-180' : ''
                                        }`}
                                />
                            </button>
                            {expandedSections.ap && (
                        ...
                        <div className="bg-orange-50 p-4 rounded-lg border-2 border-orange-200">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                                <div className="text-center">
                                    <div className="text-sm font-semibold text-gray-600 mb-1">Total Room</div>
                                    <div className="bg-white px-4 py-2 rounded border border-gray-300">1 Person</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-sm font-semibold text-gray-600 mb-1">For Sold</div>
                                    <div className="bg-white px-4 py-2 rounded border border-gray-300">2 Person</div>
                                </div>
                            </div>
