        ...
        <div className="space-y-5">
          <div>
            <p className="text-justify mt-1">
              ...
              <br /><br />
              This T&C is effective upon your subscription and governs the relationship between you and www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) including the sale and supply of any Products on the site. If this T&C conflicts with any other document, the T&C will prevail for the purposes of usage of the Site. If you do not agree to be bound by this T&C and the Privacy Policy, you may not use the Site in any way.
              <br /><br />
              ...
              <br /><br />
              The Service is not available to minors under the age of 18 or to any users suspended or removed from the system by www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) for any reason. Users may not have more than one account. Maintaining more than one account by a user shall amount to fraudulent act on part of the user and attract actions against such users. Additionally, users are prohibited from selling, trading, or otherwise transferring your www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) account to another party. If you do not qualify, you may not use the service or the Site.
              <br /><br />
              ...
              <br /><br />
              In consideration of your use of the Site, you represent that you are of legal age to form a binding contract and are not a person barred from receiving services under the laws as applicable in India. You also agree to provide true, accurate, current and complete information about yourself as prompted by the Site's registration form. If you provide any information that is untrue, inaccurate, not current or incomplete (or becomes untrue, inaccurate, not current or incomplete), or www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) has reasonable grounds to suspect that such information is untrue, inaccurate, not current or incomplete, www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) has the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof). If you use the Site, you are responsible for maintaining the confidentiality of your account and password including cases when it is being used by any of your family members, friends or relatives, whether a minor or an adult. You further agree to accept responsibility for all transactions made from your account and any dispute arising out of any misuse of your account, whether by any family member, friend, relative, any third party or otherwise shall not be entertained by the Company. Because of this, we strongly recommend that you exit from your account at the end of each session. You agree to notify www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) immediately of any unauthorized use of your account or any other breach of security. www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) reserves the right to refuse service, terminate accounts, or remove or edit content in its sole discretion.
            </p>
          </div>
          <div>
            <strong>2. Limited User :-</strong>
            <p className="text-justify mt-1">
              The User agrees and undertakes not to modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, or sell any information obtained from the Website. Limited reproduction and copying of the content of the Website is permitted provided that prior written permission of www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) is sought. For the removal of doubt, it is clarified that unlimited or wholesale reproduction, copying of the content for commercial or non-commercial purposes and unwarranted modification of data and information within the content of the website is not permitted.
            </p>
          </div>
          <div>
          ...
          <div className="space-y-5">
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>6. Intellectual Property Rights :- </b>
                Unless otherwise indicated or anything contained to the contrary or any proprietary material owned by a third party and so expressly mentioned, www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) owns all Intellectual Property Rights to and into the Website. You acknowledge and agree that you shall not use, reproduce or distribute any content from the Website belonging to www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) without obtaining authorization from www.adventureaxis.in (E Commerce Website Of Rishikesh Rent).
              </p>
            </div>
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>7. Links to Third Party Sites :- </b>
                The Website may contain links to other websites ("Linked Sites"). The Linked Sites are not under the control of www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) or the Website and www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) is not responsible for the contents of any Linked Site. www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) is providing these links to you only as a convenience, and the inclusion of any link does not imply endorsement by www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) or the Website of the Linked Sites or any association with its operators or owners including the legal heirs or assigns thereof. The users are requested to verify the accuracy of all information on their own before undertaking any reliance on such information.
              </p>
            </div>
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>8. Disclaimer of Warranties/Limitation of Liability :- </b>
                www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) has endeavored to ensure that all the information on the Website is correct, but www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) neither warrants nor makes any representations regarding the quality, accuracy or completeness of any data, information, product or Service. In no event shall www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) be liable for any direct, indirect, punitive, incidental, special, consequential damages or any other damages resulting there from. <br />
                Neither shall www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) be responsible for the delay or inability to use the Website or related services, the provision of or failure to provide Services. Further, www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) shall not be held responsible for non-availability of the Website during periodic maintenance operations or any unplanned suspension of access to the website that may occur due to technical reasons or for any reason beyond www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) control.<br />
            ...
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>9. Indemnification :- </b>
                You agree to indemnify, defend and hold harmless www.adventureaxis.in (E Commerce Website Of Rishikesh Rent)  from and against any and all losses, liabilities, claims, damages, costs and expenses (including legal fees and disbursements in connection therewith and interest chargeable thereon) asserted against or incurred by www.adventureaxis.in (E Commerce Website Of Rishikesh Rent)  that arise out of, result from, or may be payable by virtue of, any breach or non-performance of any representation, warranty, covenant or agreement made or obligation to be performed by you pursuant to these Terms.
              </p>
            </div>
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>10. Pricing :- </b>
                Prices for products are described on our Website and are incorporated into these Terms by reference. All prices are in Indian rupees. Prices, products and Services may change at www.adventureaxis.in (E Commerce Website Of Rishikesh Rent)  discretion.
              </p>
            </div>
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>11. Shipping :- </b>
                Title and risk of loss for all products ordered by you shall pass on to you upon www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) shipment to the shipping carrier. For international orders, shipping charges may differ according to location of deliver and weight of the item/s to be shipped.
              </p>
            </div>
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>12. Termination :- </b>
                www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) may suspend or terminate your use of the Website or any Service if it believes, in its sole and absolute discretion that you have breached, violated, abused, or unethically manipulated or exploited any term of these Terms or anyway otherwise acted unethically.<br />
                If you or www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) terminates your use of the Website or any Service, www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) may delete any content or other materials relating to your use of the Service and www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) will have no liability to you or any third party for doing so. You shall be liable to pay for any Service or product that you have already ordered till the time of Termination by either party whatsoever.
              </p>
            </div>
            <div>
            ...
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>16. Introduction to www.adventureaxis.in (E Commerce Website Of Rishikesh Rent) :- </b>
