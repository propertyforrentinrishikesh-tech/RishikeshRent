    ...
    try {
        ...
        const [properties, total] = await Promise.all([
            PropertyDetails.find(query)
                .select('propertyName propertyType locationType subLocationType galiType contactAddress mainImage galleryImages maxRentPrice propertyFor rentPrice isActive isTrending propertyNameSlug furnishingStatus tenantTypeAllowed petAllowed smokingAllowed alcoholAllowed nonVegAllowed muslimFamilyAllowed powerBackupAvailable lift cctv parkingAvailable housekeeping balcony wheelchair')
