...
export async function POST(req) {
    ...
    try {
        ...
        const newBanner = new BannerSection2nd({ buttonLink, order: nextOrder, image, mobileImage });
...
export async function PATCH(req) {
    ...
    try {
        ...
        const updatedBanner = await BannerSection2nd.findByIdAndUpdate(id, { buttonLink, order, image, mobileImage }, { new: true });
